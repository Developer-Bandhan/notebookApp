...
const Paste = () => {
  ...
  return (
    <div className="w-full text-white h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        ...
        {/* All Pastes */}
        <div className="flex flex-col border border-[#8079794d] py-4 rounded-[0.4rem]">
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      ...
                      <button className="p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-orange-500">
                        <a href={`/notes/${paste?._id}`} target="_blank">
                          <Eye
                    ...
                    <div className="gap-x-2 flex text-[#ffffff] ">
                      <Calendar className="text-[#ffffff]" size={20} />
